...
#define configCPU_CLOCK_HZ			( ( unsigned long ) FRECUENCIA )
#define configTICK_RATE_HZ			( ( TickType_t ) FRECUENCIA_TICK ) 
#define configMINIMAL_STACK_SIZE	( ( unsigned short ) 50 )
#define configTOTAL_HEAP_SIZE		( ( size_t ) (90 * 512 ) )
...
/* Priority 5, or 160 has only the top three bits are implemented. */
